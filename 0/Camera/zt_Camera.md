...
<p align="center">
  <img src="resources/misc_files/Logo_ZT.png" width=25% height=25%>
</p>

<p align="center">
  <img src="resources/misc_files/Logo_SP.png" width=25% height=25%>
</p>
...
`Fixture → PTZ Camera`
<p align="center">
    <img src="resources/0_SP_Add_PTZ_Camera.png" width=50% height=50%>
</p>

This should now add a camera object also on the *Viewport* pane.<br>
<p align="center">
  <img src="resources/1_SP_ViewPortPane_Camera.png" width=50% height=50%>
</p>

Add a **Tracker** object in the *Objects* pane:<br>
`Tracked Objects → Tracker`
<p align="center">
  <img src="resources/2_SP_Add_Tracker.png" width=50% height=50%>
</p>

A tracker object is now visible on the *Viewport* pane.<br>
<p align="center">
  <img src="resources/3_SP_ViewPortPane_Camera.png" width=50% height=50%>
</p>
...
<p align="center">
  <img src="resources/4_SP_Camera_Control_Options.png" width=50% height=50%>
</p>
...
<p align="center">
  <img src="resources/5_SP_Camera_Target_Selection.png" width=50% height=50%>
</p>

Now, the `Camera`'s Pan-Tilt should immediately start to point on to the Tracker.
<p align="center">
  <img src="resources/6_SP_Camera_Tracker_Connected.png" width=50% height=50%>
</p>
...
<p align="center">
  <img src="resources/7_SP_IO_Panasonic_Camera.png" width=50% height=50%>
</p>
